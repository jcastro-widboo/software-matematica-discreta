...
public class ejercicioGrafoExplicacion extends javax.swing.JDialog {
    
//Componentes caracteristicos de la venta.    
    public ejercicioGrafoExplicacion(java.awt.Dialog parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        JLTextoBienvenida.setText("EXPLICACIÓN GRAFO");
        JDPanel.add(JLTextoBienvenida);
        JLTextoBienvenida.setBounds(210, 90, 260, 30);

        JLBanner.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/caras.png"))); // NOI18N
        JDPanel.add(JLBanner);
        JLBanner.setBounds(80, 260, 430, 200);
        ...
        JLTextoBienvenida1.setBounds(20, 140, 600, 30);
        ...
        JLTextoBienvenida2.setText("Escriba un programa para determinar el número de caras y el ciclo. ");
        JDPanel.add(JLTextoBienvenida2);
        JLTextoBienvenida2.setBounds(40, 200, 540, 30);
