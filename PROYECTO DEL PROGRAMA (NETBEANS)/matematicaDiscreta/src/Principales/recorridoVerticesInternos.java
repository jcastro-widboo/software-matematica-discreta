...
public class recorridoVerticesInternos extends javax.swing.JDialog {

//Componentes caracteristicos de la venta.
    public recorridoVerticesInternos(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        JLBienvenida.setText("RECORRIDO EN ÁRBOLES BINARIOS");
        JDPanel.add(JLBienvenida);
        JLBienvenida.setBounds(120, 90, 450, 30);
...
//Boton para salir de la ventana. 
    ...
    private void JBReiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBReiniciarActionPerformed
        ...
        recorridosArbolBinario.resultado.setText(null);
    ...
    private void JBSalir2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBSalir2ActionPerformed
        ...
        new recorridoVerticesInternosExplicacion(this, true).setVisible(true);
    ...
    private void JBIngresar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JBIngresar1MouseClicked
        ...
        if (cont == cantidad) {
            ...
            resultado.append("\n");
            resultado.append(" Contenido de vértices internos: ");
            arbol.NodosHoja();
