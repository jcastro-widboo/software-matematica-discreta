...
public class recorridoVerticesInternosExplicacion extends javax.swing.JDialog {
    
//Componentes caracteristicos de la venta.    
    public recorridoVerticesInternosExplicacion(java.awt.Dialog parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        JLTextoBienvenida.setText("EXPLICACIÓN VÉRTICES INTERNOS");
        ...
        JLBanner.setBounds(220, 220, 250, 261);
        ...
        JLTextoBienvenida2.setText("Algoritmo recursivo que muestre el contenido de los vértices internos.");
        JDPanel.add(JLTextoBienvenida2);
        JLTextoBienvenida2.setBounds(40, 180, 550, 30);
